...
checkpoint = torch.load('3_max_pool/97.torch')
...
def evaluate():
	...
	for i,batch in enumerate(val_loader):
		...
		# 	TPs = 0
		# 	segb = seg[b,::].reshape(-1)
		# 	annb = ann[b,::].reshape(-1)
		# 	Predb = Pred[b,::].reshape(-1,6)

		# 	top_indx = segb == 5
		# 	top_values = Predb[top_indx][:,5]
		# 	_,top10 = torch.topk(top_values,10)
		# 	for t in top10:
		# 		top = torch.where(segb==5)[0][t]
		# 		if annb[top] > 1:
		# 			TPs += 1
		# 			print(annb[top])
		# 	print('TPs',TPs)
