...
TrainFolder="../../data/data_high/train"
ValFolder="../../data/data_mid/val"
...
train_dataset = Dataset(TrainFolder,transform=transformImg,type=type)
train_loader = data.DataLoader(train_dataset, batch_size=batchSize, shuffle=True,
  num_workers=2)

val_dataset = Dataset(ValFolder,transform=transformImg,type=type)
...
for epoch in range(start_epoch,100): # Training loop
	...
	for i,batch in enumerate(train_loader):
		...
		Loss=mse_loss_weighted(Pred,torch.div(ann,100))
