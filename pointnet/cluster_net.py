...
class ClusterNet(nn.Module):
	...
	def __init__(self,input_feature_dim=0, num_proposal=128, vote_factor=1, sampling='seed_fps', testing=False):
		...
		self.gqs_net = GraspabilityModule(self.vote_factor, 256)
		self.angle_net = GraspabilityModule(self.vote_factor, 256)
		self.width_net = GraspabilityModule(self.vote_factor, 256)

		self.ab_net = AngleBinModule(self.vote_factor, 256)
