...
class GDI2:
    ...
    def calculate_gdi_plus_score_better_way(self):
        bmap = self.bmap
        gdi_plus_count_upper = gdi_plus_max - bmap[:self.new_centroid[0],self.new_centroid[1]-THRESHOLD3:self.new_centroid[1]+THRESHOLD3].sum()
        gdi_plus_count_lower = gdi_plus_max - bmap[self.new_centroid[0]:,self.new_centroid[1]-THRESHOLD3:self.new_centroid[1]+THRESHOLD3].sum()
...
gdi_plus_max = 2*(gripper_width/2)*THRESHOLD3
