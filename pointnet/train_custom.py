...
def train_one_epoch():
	...
	for batch_idx, batch_data_label in enumerate(TRAIN_DATALOADER):
		...
		loss = end_points['gqs_loss'] + end_points['rgs_loss']  + end_points['width_loss'] #+ end_points['angle_loss']
...
def train(start_epoch):
	...
	for epoch in range(start_epoch, MAX_EPOCH):
		...
		plt.plot(loss_list_rgs)
		plt.savefig(os.path.join(LOG_DIR,'loss_rgs.png'))
		plt.clf()
