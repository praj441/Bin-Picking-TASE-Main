...
from utils_gs import Parameters, draw_grasp_map, draw_top_N_points, draw_grasp_pose_as_a_line
...
scan_names = ['000000'] #,'000009']
avg_time = 0.0
scenes = 1
for i,idx in enumerate(scan_names):
	if i == 50:
		break
	print(idx)
	...
	draw_grasp_map(gqs_map,dump_dir+'/gqs_map.png')
	...
	cv2.imwrite(dump_dir+'/topN_points.png',topN_img)
	...
	cv2.imwrite(dump_dir+'/sampled_poses.png',sampled_poses_img)
	...
	cv2.imwrite(dump_dir+'/valid_poses.png', valid_poses_img)
	...
	cv2.imwrite(dump_dir+'/z_final_pose.png', final_img)
